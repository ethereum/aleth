...
This repository contains [cpp-ethereum](http://cpp-ethereum.org), the [Ethereum](https://ethereum.org) C++ client, also known as Aleth (short for Alpha Eth, indicating the first Ethereum client) or Eth.

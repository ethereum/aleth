...
public:
	...
	ExecutionResult execute(std::shared_ptr<LastBlockHashesFace const> _lh, Transaction const& _t, Permanence _p = Permanence::Committed, OnOpFunc const& _onOp = OnOpFunc());

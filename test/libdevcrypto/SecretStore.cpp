...
BOOST_AUTO_TEST_CASE(vector_PBKDF2SHA256, *utf::expected_failures(1))
{
	// Imports a key from an external file. Tests that the imported key is there
	// and that the external file is not deleted.
	TransientDirectory importDir;
...
BOOST_AUTO_TEST_CASE(vector_Scrypt, *utf::expected_failures(1))
{
	// Imports a key from an external file. Tests that the imported key is there
	// and that the external file is not deleted.
	TransientDirectory importDir;
...
BOOST_AUTO_TEST_CASE(vector_Scrypt2, *utf::expected_failures(2))
{
	// Imports a key from an external file. Tests that the imported key is there
	// and that the external file is not deleted.
	TransientDirectory importDir;

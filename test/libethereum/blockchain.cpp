...
BOOST_AUTO_TEST_CASE(blockInfo)
{
	string genesisRLP = "";
	bytes genesisBlockRLP = dev::test::importByteArray(genesisRLP);
	...
	BlockChain trueBc(genesisBlockRLP, td2.path(), WithExisting::Kill);
	...
	string blockRLPstr = "";
	bytes blockRLP = dev::test::importByteArray(blockRLPstr);
	BlockInfo block(blockRLP);
	trueBc.import(blockRLP, trueState.db());
	trueState.sync(trueBc);

	if (trueState.info() != trueBc.info())
	{
		cnote << "Block.info() in blockchain does not equal block.info() in synced state: ";
		cnote << trueBc.info();
		cnote << "vs";
		cnote << trueState.info();
		BOOST_ERROR("Block.info() mismatch!");
	}
}

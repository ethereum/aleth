...
macro(eth_check_prelibrary_link PRE L)
	if (${${PRE}_${L}_LIBRARY} AND (${${PRE}_${L}_LIBRARY} EQUAL "${PRE}_${L}_LIBRARY-NOTFOUND"))
		unset(${${PRE}_${L}_LIBRARY})
	endif()
	if (${${PRE}_${L}_LIBRARY_DEBUG} AND (${${PRE}_${L}_LIBRARY_DEBUG} EQUAL "${PRE}_${L}_LIBRARY_DEBUG-NOTFOUND"))
		unset(${${PRE}_${L}_LIBRARY_DEBUG})
	endif()
	if (${${PRE}_${L}_LIBRARY} AND ${${PRE}_${L}_LIBRARY_DEBUG})
		set(${PRE}_${L}_LIBRARIES optimized ${${PRE}_${L}_LIBRARY} debug ${${PRE}_${L}_LIBRARY_DEBUG})
	elseif (${${PRE}_${L}_LIBRARY})
		set(${PRE}_${L}_LIBRARIES ${${PRE}_${L}_LIBRARY})
	elseif (${${PRE}_${L}_LIBRARY_DEBUG})
		set(${PRE}_${L}_LIBRARIES ${${PRE}_${L}_LIBRARY_DEBUG})
	endif()
endmacro()

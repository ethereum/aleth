...
enum class Instruction: uint8_t
{
	...
	XSHUFFLE = 0xbd,    ///< shuffle vector via permutation mask
	XPUSH,              ///< push vector on stack
	XCAST,              ///< convert from type of vector to another

	XLT = 0xc0,         ///< less-than comparision
	...
	XINDEX,             ///< retrieve single element from vector
	XSHL,               ///< shift left opertation

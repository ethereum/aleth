...
{ //                                               Add,  Args,  Ret,  SideEffects, GasPriceTier
	...
	{ Instruction::JUMPTO,       { "JUMPTO",         4,     1,    0,  true,        VeryLowTier } },
	{ Instruction::JUMPIF,       { "JUMPIF",         4,     2,    0,  true,        LowTier } },
	{ Instruction::JUMPV,        { "JUMPV",          4,     1,    0,  true,        MidTier } },
	{ Instruction::JUMPSUB,      { "JUMPSUB",        4,     1,    0,  true,        LowTier } },
	{ Instruction::JUMPSUBV,     { "JUMPSUBV",       4,     1,    0,  true,        MidTier } },
	{ Instruction::RETURNSUB,    { "RETURNSUB",      0,     1,    0,  true,        MidTier } },
	...
	{ Instruction::BEGINDATA,    { "BEGINDATA",      0,     0,    0,  true,        SpecialTier } },
	{ Instruction::BEGINSUB,     { "BEGINSUB",       0,     0,    0,  true,        SpecialTier } },
	...
	{ Instruction::JUMPC,        { "JUMPC",          0,     1,     0,   true,      MidTier } },
	{ Instruction::JUMPCI,       { "JUMPCI",         0,     1,     0,   true,      HighTier } },

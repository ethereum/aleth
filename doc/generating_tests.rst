...
* `install Docker`_
* ``docker run -v <LOCAL_PATH_TO_ETH_TESTS>:/foobar winsvega/testeth -t GeneralStateTests/stCallCodes -- --singletest callcall_00 --singlenet EIP150 -d 0 -g 0 -v 0 --statediff --verbosity 5 --testpath /foobar`` should show something like
